...
const MapContainer = ({
      ...
      if (enableStationClustering) {
        ...
        stationArray.forEach(station => {
          const marker = L.marker([station.lat, station.lon], {
            icon: createStationIcon(station.pol_a, station.pol_b, station.unit, visiblePollutants)
          });
        ...
        stationGroups.forEach(stationGroup => {
          ...
          const marker = L.marker([representative.lat, representative.lon], {
            icon: createStationIcon(representative.pol_a, representative.pol_b, representative.unit, visiblePollutants)
          });
        ...
        validStations.forEach(station => {
          ...
          let icon;
          if (isFocused) {
            icon = createFocusedStationIcon(station.pol_a, station.pol_b, station.unit, visiblePollutants);
          } else if (isHighlighted) {
            icon = createHighlightedStationIcon(station.pol_a, station.pol_b, station.unit, visiblePollutants);
          } else {
            icon = createStationIcon(station.pol_a, station.pol_b, station.unit, visiblePollutants);
          }
  ...
  }, [mapLoaded, stationData, showStationMarkers, showHeatmap, heatmapOpacity, heatmapRadius, enableStationClustering, enableRecordClustering, showRecordCount, currentZoom, clearMapLayers, visiblePollutants]);
